...
namespace Castle.DynamicProxy.Generators
{
	...
	public class CompositionInvocationTypeGenerator : InvocationTypeGenerator
	{
		...
		public CompositionInvocationTypeGenerator(Type target, MethodInfo method, MethodInfo callback, bool canChangeTarget, IInvocationCreationContributor contributor)
